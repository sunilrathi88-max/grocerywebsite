...
| ------------------- | ------ | ------------------------------------------------------------------------------------------------------- | ------- | --------------------------------------------------------------- |
| `aspect_ratio`      | string | "1:1", "2:3", "3:2", "3:4", "4:3", "4:5", "5:4", "9:16", "16:9", "21:9", "1:4"_, "4:1"_, "1:8"_, "8:1"_ | "1:1"   | \* = Nano Banana 2 only                                         |
| `image_size`        | string | "512"_, "1K", "2K"_, "4K"\*                                                                             | "1K"    | MUST be uppercase. "2k" silently fails. \* = Nano Banana 2 only |
