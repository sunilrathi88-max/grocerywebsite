...
export const SAMPLE_PRODUCTS: Partial<Product>[] = [
  {
    ...
    description:
      'Authentic Kashmiri saffron threads, grade A quality with deep red color and rich aroma.',
    price: 2499,
    compare_price: 2999,
    stock: 50,
    status: 'active',
...

  {
    ...
    description:
      '100% pure organic turmeric powder with high curcumin content. No additives or preservatives.',
    price: 299,
    compare_price: 349,
    stock: 200,
    status: 'active',
...

  {
    ...
    description:
      'Pure Himalayan pink salt crystals, rich in 84 trace minerals. Perfect for cooking and seasoning.',
    price: 199,
    stock: 150,
    status: 'active',
...

  {
    ...
    description:
      'Premium whole black peppercorns with bold flavor and aroma. Freshly sourced from Kerala plantations.',
    price: 449,
    compare_price: 499,
    stock: 100,
    status: 'active',
...

  {
    ...
    description:
      'Premium Ceylon cinnamon sticks with sweet, delicate flavor. Perfect for tea, desserts, and curries.',
    price: 349,
    stock: 75,
    status: 'active',
