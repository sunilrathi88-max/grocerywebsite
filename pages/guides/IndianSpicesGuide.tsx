  ...
  const faqs = [
    {
      ...
      answer:
        'Ramganj Mandi is historically renowned for producing the highest volatile oil content coriander in India. Sourcing directly from here ensures maximum aroma and flavor, unlike mass-market blends that mix various low-grade regional yields.',
    },
    {
      question: 'What is the difference between hot-ground and cold-ground spices?',
      answer:
        "Mass-production hot-grinding utilizes high-speed machines that can heat spices over 90°C, destroying essential volatile oils. Cold-grinding is a slow process that preserves the spice's natural aroma, medicinal properties, and vibrant color.",
    },
    {
      question: 'How can I tell if Salem Turmeric is authentic?',
      answer:
        'Authentic Salem Turmeric is distinguished by its exceptionally high curcumin content (above 3%) and deep, fluorescent yellow-orange color. It has a significantly earthier, more robust flavor profile compared to generic turmeric powder.',
    },
  ];
  ...
  return (
    ...
    >
      <section id="introduction" className="scroll-mt-24 mb-12">
        ...
        <p>
          In the modern era of convenience, the authentic, powerful flavors of Indian spices have
          been diluted by mass-market blending. Single-origin sourcing—procuring spices from
          specific, historically potent geographic regions—is the only way to experience flavors as
      ...
      <section id="ramganj-mandi-coriander" className="scroll-mt-24 mb-12">
        ...
        <p>
          ...
          coriander seeds with extraordinarily high volatile essential oils.
        </p>
        <div className="bg-brand-primary/5 border border-brand-primary/20 p-6 rounded-xl my-6">
          ...
          <p className="mb-0 text-sm">
            Authentic Ramganj Mandi coriander powder boasts a vibrant, citrusy-green aroma. If your
            coriander smells dusty or lacks a lemon-pine scent, it has likely lost its volatile oils
            or is highly diluted.
          </p>
        </div>
      </section>
      ...
      <section id="salem-turmeric" className="scroll-mt-24 mb-12">
        ...
        <p>
          Not all turmeric is created equal. Salem, a city in Tamil Nadu, produces turmeric with a
          curcumin content significantly higher than the national average. Curcumin is the active
          compound responsible for both the brilliant yellow color and the profound
          anti-inflammatory health benefits.
        </p>
        <p>
          When shopping, look for the deep, almost fluorescent orange-yellow hue characteristic of
          the Salem variety, rather than a dull, washed-out yellow.
        </p>
      </section>
      ...
      <section id="mathania-chilli" className="scroll-mt-24 mb-12">
        ...
        <p>
          Mathania, a small village near Jodhpur, is legendary for its red chillies. Known for
          delivering intense, vibrant red color to dishes like Laal Maas without overwhelming heat,
          it is the crown jewel of Rajasthani cuisine.
        </p>
      </section>
