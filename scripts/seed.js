...
const MOCK_PRODUCTS = [
    {
        ...
        description: 'Known as "Red Gold," our Himalayan Saffron is hand-harvested from the pristine valleys of Kashmir. These deep crimson strands (Mongra grade) possess a potent aroma and flavor. Your dishes will taste alive—never bland again.',
        ...
        reviews: [
            { author: 'Priya K.', rating: 5, comment: 'Absolutely divine! The aroma filled my kitchen. Best saffron I have ever used.', verifiedPurchase: true, date: '2023-10-15', helpful: 12 },
            { author: 'Raj S.', rating: 5, comment: 'Top quality product. Worth every penny.', verifiedPurchase: true }
        ],
    ...
    },
    {
        ...
        description: 'Sourced directly from the Malabar coast, these bold black peppercorns are sun-dried to preserve their sharp, biting heat and complex citrusy aroma. Rich in piperine for a robust kick. Your dishes will taste alive—never bland again.',
        images: ['/images/products/tattv-malabar-black-pepper-front.png'],
        category: 'Spices',
        variants: [{ name: '250g', price: 300, stock: 30 }],
        reviews: [
            { author: 'Chef Maria', rating: 5, comment: 'As a chef, I can tell the difference. This is the real deal.', verifiedPurchase: false }
        ],
        origin: 'Kerala, India',
    ...
    },
    {
        ...
        description: 'Sourced from the best orchards in California, Tattv Almonds are sweet, crunchy, and packed with healthy fats, protein, and Vitamin E. Perfect for snacking or making rich Badam milk.',
        ...
        reviews: [{ author: 'Anjali P.', rating: 5, comment: 'So delicious and crunchy. You can taste the quality.', verifiedPurchase: true }],
        origin: 'Kashmir, India',
    ...
    },
    {
        ...
        description: 'The Golden Standard of Purity. Sourced from the Salem region of Tamil Nadu, known for its rich essential oils and high curcumin content. This deep golden-orange powder is pure, healing, and free from artificial colors. Your dishes will taste alive—never bland again.',
        ...
        reviews: [
            { author: 'John D.', rating: 5, comment: 'The color and smell are so much richer than store-bought turmeric. Excellent!', verifiedPurchase: true },
            { author: 'Emily R.', rating: 4, comment: 'Great product, makes a wonderful turmeric latte.', verifiedPurchase: true }
        ],
    ...
    },
    {
        ...
        description: 'For those who love their tea strong and bold. A blend of premium CTC granules that brews a dark, malty cup with a rich amber color. Delivers the authentic "Kadak" taste of India.',
        images: [
        ...
        reviews: [
            { author: 'Sophie L.', rating: 5, comment: 'An exquisite tea. Delicate and so refreshing.', verifiedPurchase: true },
        ],
    ...
    },
    {
        ...
        description: 'Experience the superior taste of Indian cashews. Renowned for their large size, ivory color, and naturally sweet, buttery taste. Expertly processed to ensure they remain whole and crunchy.',
        ...
        reviews: [
            { author: 'Michael B.', rating: 5, comment: 'Best cashews I have ever had. So fresh and crunchy.', verifiedPurchase: true },
        ],
        origin: 'Goa, India',
    ...
    },
    {
        ...
        description: 'Grown in the misty hills of Coorg, handpicked at peak ripeness. Bursting with sweet, floral notes and refreshing menthol undertones. Essential for Masala Chai and rich desserts.',
    ...
    },
    {
        ...
        description: 'Provides a warm, sweet-spicy flavor profile. Perfect for steeping in tea, adding to rice pilafs, or grinding into baking spice mixes. Adds natural sweetness without sugar.',
    ...
    },
    {
        ...
        description: 'Discover the Legend of Mathania. Sourced directly from the arid soils of Jodhpur, this "Red Gold" delivers a unique pungent heat and vibrant color perfect for authentic Rajasthani marinades and curries.',
    ...
    },
    {
        ...
        description: 'Light, crisp, and full of citrusy, woody notes. Perfect for dry roasting and grinding fresh at home, or for crushing coarsely into Samosa fillings and pickles.',
    ...
    },
    {
        ...
        description: 'Cleaned and sorted to ensure zero dust or stones. They release an intense, nutty, and earthy aroma when tempered in hot oil/ghee. A digestive aid and flavor powerhouse.',
    ...
    },
    {
        ...
        description: 'Vibrant green and naturally sweet. Traditionally used as a post-meal digestive and mouth freshener (Mukhwas), they add a subtle anise-like sweetness to curries and pickles.',
    ...
    },
    {
        ...
        description: 'Small in size but big on flavor. These seeds pop with a nutty, pungent kick when tempered. Essential for South Indian curries, pickles, and Bengali fish dishes.',
    ...
    },
    {
        ...
        description: 'Known for their maple-like aroma and subtle bitterness. A staple for pickles and Sambars. Rich in fiber and known to support blood sugar health.',
    ...
    },
    {
        ...
        description: 'Roasted to perfection to bring out their nutty flavor. Bursting with vibrant green kernels inside naturally open shells. A fiber-rich snack that is as delicious as it is healthy.',
    ...
    },
    {
        ...
        description: 'Fresh, earthy, and mildly bitter-sweet. Shelled carefully to keep the butterfly halves intact. Rich in Omega-3 fatty acids, the ultimate brain food.',
    ...
    },
    {
        ...
        description: 'Dried to a golden-brown perfection. Plump, juicy, and naturally sweet. Perfect for adding to Kheer, Pulao, or eating by the handful for an instant energy boost.',
    ...
    },
    {
        ...
        description: 'Rope dried to concentrate their sweetness and form a chewy, seed-filled texture. Known for high fiber and calcium content, a delicious natural treat.',
        images: ['https://images.unsplash.com/photo-1596040033229-a9821ebd058d?auto=format&fit=crop&w=800&q=80'],
        category: 'Dry Fruits',
    ...
    },
    {
        ...
        description: 'The Soul of Your Morning Cup. A natural blend dominated by premium Green Cardamom and dry Ginger, balanced with Clove and Cinnamon. No sugar, no fillers—just 100% pure aromatic spices.',
    ...
    },
    {
        ...
        description: 'A Symphony of Spices. A premium blend of 15+ dry-roasted whole spices, including Cardamom and Mace. Just a pinch at the end of cooking transforms a simple dish into a gourmet feast.',
    ...
    },
    {
        ...
        description: 'Freshness You Can Smell. Stone-ground from organic coriander seeds to preserve the volatile oils responsible for that citrusy aroma. The perfect thickener and flavor enhancer for gravies.',
        images: ['/images/products/coriander-powder-front.jpg', '/images/products/coriander-powder-back.jpg'],
        category: 'Spices',
        variants: [
