...
const PROCESS_STEPS = [
  ...
  },
  {
    ...
    imageUrl:
      'https://images.unsplash.com/photo-1615486171448-4fdcbef5dbbd?auto=format&fit=crop&w=800&q=80',
  },
  {
    id: '03',
    title: 'Cold Grinding',
    ...
    imageUrl:
      'https://images.unsplash.com/photo-1596040033229-a9821ebd058d?auto=format&fit=crop&w=800&q=80', // using placeholder, user will replace with actual spice powder macro
  },
];
  ...
  return (
    <section ref={sectionRef} className="w-full bg-char relative pb-24 lg:pb-0">
      ...
      <div className="hidden lg:flex w-full items-start">
        ...
        <div
          ref={leftRef}
          className="w-1/2 flex flex-col pt-[30vh] pb-[40vh] px-12 xl:px-24 border-r border-mist/10"
        >
          <div className="mb-32">
            <span className="text-saffron tracking-[0.2em] font-bold text-xs uppercase mb-4 block">
              The Methodology
            </span>
            <h2 className="text-5xl font-serif text-cream leading-tight">
              Zero Compromises. <br />
              <span className="italic text-dust">From Soil to Seal.</span>
            </h2>
          </div>
          ...
          {PROCESS_STEPS.map((step, idx) => (
            ...
            >
              ...
              <p className="text-dust text-lg font-light leading-relaxed">{step.desc}</p>
            </div>
          ))}
        </div>
      ...
      <div className="lg:hidden container mx-auto px-4 pt-24">
        <div className="mb-16 text-center">
          ...
          <h2 className="text-4xl font-serif text-cream leading-tight">
            Zero Compromises. <br />
            <span className="italic text-dust">From Soil to Seal.</span>
          </h2>
        </div>
        ...
        <div className="flex flex-col gap-16">
          {PROCESS_STEPS.map((step) => (
            <div
              key={`mob-${step.id}`}
              className="process-step-mobile flex flex-col w-full bg-ink rounded-lg overflow-hidden border border-mist/20"
            >
              <div className="h-64 w-full relative">
                ...
                <div className="absolute top-4 left-4 text-4xl font-serif text-saffron/80 font-bold">
                  {step.id}
                </div>
              </div>
              <div className="p-8">
                ...
                <p className="text-dust text-sm font-light leading-relaxed">{step.desc}</p>
              </div>
            </div>
          ))}
        </div>
