            ...
            <div className="p-4 border-b border-neutral-100 bg-neutral-50">
                ...
                <div className="flex items-center gap-3">
                    <button
                        ...
                        className={`px-4 py-2 text-sm font-medium rounded-full transition-all ${!isAdvancedMode
                ...
                {!isAdvancedMode && (
                    <p className="text-xs text-neutral-500 mt-2">
                        Showing essential filters • <button onClick={() => setIsAdvancedMode(true)} className="text-amber-600 hover:underline">Show all {filters.length} filter groups</button>
                    </p>
                )}
            </div>
                            ...
                            {group.options.map((option) => {
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        />
                                        <span className={`text-sm ${isSelected ? 'font-medium text-neutral-900' : 'text-neutral-600 group-hover:text-neutral-900'}`}>
                                            {option.label}
                                        </span>
