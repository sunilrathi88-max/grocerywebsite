        ...
        <div className="grid md:grid-cols-2">
          ...
          <div className="p-8">
            ...
            <p className="text-gray-600 mb-6 leading-relaxed">
              &quot;I&apos;ve been growing turmeric on my family&apos;s land in Telengana for 25
              years. We don&apos;t use chemical sprays—only neem oil and natural compost. Rathi
              Naturals. pays us fair rates, which lets me send my daughter to college.&quot;
            </p>
