...
const cookingKits: Record<string, CookingKit> = {
    dal: {
        ...
        products: [
            { id: 1, name: 'Turmeric Powder', image: '/images/products/turmeric-powder-front.jpg', price: 149 },
            { id: 2, name: 'Cumin Seeds', image: '/images/products/tattv-cumin-seeds-front.jpg', price: 179 },
            { id: 3, name: 'Coriander Powder', image: '/images/products/coriander-powder-front.jpg', price: 129 },
    ...
    chai: {
        ...
        products: [
            ...
            { id: 6, name: 'Green Cardamom', image: '/images/products/tattv-coorg-green-cardamom-front.jpg', price: 349 },
            { id: 7, name: 'Cinnamon Bark', image: '/images/products/tattv-cinnamon-bark-front.png', price: 199 },
        ],
        discount: 12,
        bundlePrice: 613,
    },
    curry: {
        ...
        products: [
            { id: 8, name: 'Turmeric Powder', image: '/images/products/turmeric-powder-front.jpg', price: 149 },
            { id: 9, name: 'Red Chilli Powder', image: '/images/products/red-chilli-powder-front.jpg', price: 169 },
            { id: 10, name: 'Coriander Powder', image: '/images/products/coriander-powder-front.jpg', price: 129 },
            { id: 11, name: 'Garam Masala', image: '/images/products/garam-masala-front.jpg', price: 199 },
        ],
        discount: 18,
        bundlePrice: 529,
    },
    biryani: {
        ...
        products: [
            { id: 12, name: 'Garam Masala', image: '/images/products/garam-masala-front.jpg', price: 199 },
            { id: 13, name: 'Green Cardamom', image: '/images/products/tattv-coorg-green-cardamom-front.jpg', price: 349 },
            { id: 14, name: 'Cinnamon Bark', image: '/images/products/tattv-cinnamon-bark-front.png', price: 199 },
            { id: 15, name: 'Black Pepper', image: '/images/products/tattv-malabar-black-pepper-front.png', price: 249 },
        ],
        discount: 20,
        bundlePrice: 797,
    },
            ...
            <div className="container mx-auto px-4 md:px-6">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-neutral-600 max-w-xl mx-auto">
                        Select what you're cooking and get the complete spice kit with exclusive bundle discounts
                    </p>
                </div>
