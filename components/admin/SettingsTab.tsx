                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => setStoreSettings({ ...storeSettings, fssaiLicense: e.target.value })}
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-brand-primary focus:border-brand-primary"
                    ...
                    <div className="space-y-4">
                        ...
                        {paymentSettings.razorpayEnabled && (
                            <div>
                                ...
                                />
                                <p className="text-xs text-gray-500 mt-1">Your Razorpay API Key ID (starts with rzp_)</p>
                            </div>
                        )}
                        ...
                        <div className="flex items-center gap-4">
                            <label className="flex items-center gap-2 cursor-pointer">
                                <input
                                    ...
                                    onChange={(e) => setPaymentSettings({ ...paymentSettings, cashfreeEnabled: e.target.checked })}
                                    className="w-5 h-5 text-brand-primary border-gray-300 rounded focus:ring-brand-primary"
                                />
                        ...
                        {paymentSettings.cashfreeEnabled && (
                            <div>
                                <label className="block text-sm font-medium text-gray-700 mb-1">Cashfree App ID</label>
                                <input
                                    type="text"
                                    value={paymentSettings.cashfreeAppId}
                                    onChange={(e) => setPaymentSettings({ ...paymentSettings, cashfreeAppId: e.target.value })}
                                    className="w-full max-w-md px-4 py-2 border border-gray-300 rounded-lg focus:ring-brand-primary focus:border-brand-primary"
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                            ...
                            <input
                                ...
                                onChange={(e) => setShippingSettings({ ...shippingSettings, defaultShippingRate: Number(e.target.value) })}
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-brand-primary focus:border-brand-primary"
                            />
                        </div>
                        <div>
                        ...
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Metro Delivery Days</label>
                            <input
                                type="number"
                                value={shippingSettings.metroDeliveryDays}
                                onChange={(e) => setShippingSettings({ ...shippingSettings, metroDeliveryDays: Number(e.target.value) })}
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-brand-primary focus:border-brand-primary"
                            />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 mb-1">Non-Metro Delivery Days</label>
                            <input
                                type="number"
                                value={shippingSettings.nonMetroDeliveryDays}
                                onChange={(e) => setShippingSettings({ ...shippingSettings, nonMetroDeliveryDays: Number(e.target.value) })}
                                className="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-brand-primary focus:border-brand-primary"
                            />
                        </div>
                    </div>
