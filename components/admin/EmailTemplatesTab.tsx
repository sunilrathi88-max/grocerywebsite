...
const EmailTemplatesTab: React.FC = () => {
    ...
    const getPreviewContent = (body: string) => {
        ...
        return body
            ...
            .replace(/\{\{order_items\}\}/g, '• Organic Turmeric (200g) ×2\n• Malabar Black Pepper (250g) ×1')
                        ...
                        <div className="divide-y">
                            {templates.map((template) => (
                                <button
                                    ...
                                    className={`w-full p-4 text-left hover:bg-gray-50 transition-colors ${selectedTemplate?.id === template.id ? 'bg-brand-secondary/20 border-l-4 border-brand-primary' : ''
                                        }`}
                                >
                                    <div className="flex items-center justify-between">
                                        <span className="font-medium text-gray-900">{template.name}</span>
                                        <span
                                            className={`px-2 py-1 rounded text-xs ${template.type === 'transactional'
                            ...
                            <div className="p-4 border-b flex justify-between items-center">
                                ...
                                <div className="flex gap-2">
                                    <button
                                        ...
                                        className={`px-4 py-2 rounded-lg text-sm font-medium ${isPreview
