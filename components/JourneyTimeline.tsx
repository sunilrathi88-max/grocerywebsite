                ...
                <div className="grid grid-cols-1 md:grid-cols-4 gap-12 relative z-10">
                    ...
                    <div className="group relative flex flex-col items-center text-center timeline-item cursor-default">
                        ...
                        <div className="mt-6 px-4">
                            ...
                            <h4 className="font-serif text-2xl text-accent-charcoal mb-3">
                                Harvest
                            </h4>
                            <p className="text-sm text-accent-charcoal/60 leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform translate-y-2 group-hover:translate-y-0">
                                Hand-picked at peak potency from our partner farms in Kerala and
                                Guntur.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="group relative flex flex-col items-center text-center timeline-item cursor-default">
                        ...
                        <div className="mt-6 px-4">
                            ...
                            <p className="text-sm text-accent-charcoal/60 leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform translate-y-2 group-hover:translate-y-0">
                                Naturally dried under the sun to preserve essential oils and
                                natural color.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="group relative flex flex-col items-center text-center timeline-item cursor-default">
                        ...
                        <div className="mt-6 px-4">
                            ...
                            <p className="text-sm text-accent-charcoal/60 leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform translate-y-2 group-hover:translate-y-0">
                                Rigorously tested for purity, potency, and safety standards in
                                ISO labs.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="group relative flex flex-col items-center text-center timeline-item cursor-default">
                        ...
                        <div className="mt-6 px-4">
                            ...
                            <p className="text-sm text-accent-charcoal/60 leading-relaxed opacity-0 group-hover:opacity-100 transition-opacity duration-500 transform translate-y-2 group-hover:translate-y-0">
                                Sealed in eco-friendly packaging to deliver farm freshness to
                                your home.
                            </p>
                        </div>
                    </div>
