      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-20">
          ...
          <p className="text-stone-500 text-lg max-w-2xl mx-auto leading-relaxed">
            Have a question about our cold-ground process or looking for a specific single-origin
            spice? Our team of spice enthusiasts is here to help.
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-8">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    id="name"
                    required
                    className="w-full bg-[#FAF6F2] border-none rounded-xl p-4 text-stone-900 focus:ring-2 focus:ring-[#B38B59] outline-none"
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  rows={6}
                  required
                  className="w-full bg-[#FAF6F2] border-none rounded-xl p-4 text-stone-900 focus:ring-2 focus:ring-[#B38B59] outline-none resize-none"
            ...
            <div className="space-y-8">
              <div className="flex items-start gap-6 group">
                ...
                <div>
                  ...
                  <p className="text-[#42210B] font-display text-xl font-bold mb-1">
