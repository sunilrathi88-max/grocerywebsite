...
const questions = [
  ...
  },
  {
    ...
    correct: 1,
    feedback: 'That\'s right! Our premium cashews meet the highest standards in size, color, and shape.',
    points: 10
  }
];
...
const QuizModule: React.FC<QuizModuleProps> = ({ addToast }) => {
    ...
    if (showResult) {
        ...
        return (
            ...
            >
                ...
                <div className="mb-6">
                    {result.score === questions.length && (
                        <p className="text-xl text-green-600 font-bold mb-2">🎉 Perfect Score! You're a Spice Master!</p>
                    )}
                    {result.score >= questions.length - 2 && result.score < questions.length && (
                        <p className="text-xl text-blue-600 font-bold mb-2">🌟 Excellent! You know your spices!</p>
                    )}
                    ...
                    {result.score < questions.length / 2 && (
                        <p className="text-xl text-gray-600 font-bold mb-2">📚 Nice try! Practice makes perfect!</p>
                    )}
                </div>
                ...
                <div className="bg-gray-50 rounded-lg p-6 mb-6">
                    <p className="text-lg text-gray-700 mb-4">
                        Your Score: <span className="text-3xl font-bold text-brand-primary">{result.score}</span> 
                    ...
                    <div className="mt-4 bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                        ...
                        <p className="text-2xl font-bold text-yellow-600">{earnedPoints} / {totalPoints}</p>
                    </div>
                </div>
                ...
                {promo && (
                    ...
                    >
                        ...
                        <p className="text-xs mt-3 text-white/80">
                            {result.score === questions.length ? '15% off your next order!' : '10% off your next order!'}
                        </p>
                    </motion.div>
                )}
    ...
    return (
        <div className="bg-white p-8 rounded-lg shadow-lg">
            ...
            {isAnswered && (
                <motion.div {...{ initial: { opacity: 0, y: 10 }, animate: { opacity: 1, y: 0 }, transition: { delay: 0.2 }, className: "mt-6 p-4 bg-brand-accent rounded-lg" } as any}>
