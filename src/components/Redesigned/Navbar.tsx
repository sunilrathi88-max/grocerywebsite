    ...
    <div className="sticky top-0 z-[100]">
      ...
      >
        ...
        <div className="flex items-center gap-4">
                        ...
                        <div className="space-y-1">
                          {autocompleteResults.posts.map((post) => (
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                <div className="text-sm font-bold text-bark truncate group-hover:text-gold">
                                  {post.title}
                                </div>
                                <div className="text-[10px] text-sage line-clamp-1 italic">
                                  {post.excerpt}
                                </div>
                              </div>
                            </button>
          ...
          <Link
            to="/account"
            className="hidden md:flex text-cream hover:text-gold transition-colors"
          >
          ...
          <Link
            to="/cart"
            className="relative flex items-center justify-center text-cream hover:text-gold transition-colors"
          >
          ...
          >
            <div className="flex flex-col py-6 px-8 space-y-6 flex-1 overflow-y-auto">
              ...
              <Link
                to="/account"
                onClick={() => setIsMobileMenuOpen(false)}
                className="text-gold font-body font-bold uppercase tracking-widest text-sm"
              >
                Login / Account
              </Link>
            </div>
            ...
            <div className="p-6 bg-forest/80 border-t border-white/10">
              <form onSubmit={handleSearch} className="flex h-12 w-full">
                ...
                <button
                  type="submit"
                  className="px-6 bg-gold text-white rounded-r-md flex items-center justify-center"
                >
                  <Search size={20} />
                </button>
              </form>
