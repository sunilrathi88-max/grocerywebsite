  ...
  if (!product)
    return (
      <div className="py-24 text-center bg-[#FAF6F2] min-h-screen">
        ...
        <Link to="/shop" className="text-[#B38B59] font-bold underline">
          Back to shop
        </Link>
      </div>
    );
    ...
    <div className="bg-[#FAF6F2] min-h-screen pb-20">
      <div className="max-w-7xl mx-auto px-4 md:px-8 py-10">
        ...
        <div className="flex items-center gap-2 text-[10px] font-bold uppercase tracking-widest text-stone-400 mb-8">
          ...
          <span>/</span>
          <Link to="/shop" className="hover:text-[#B38B59] transition-colors">
            Shop
          </Link>
          <span>/</span>
          ...
          <div className="space-y-6 lg:sticky lg:top-32">
            ...
            <div className="flex flex-wrap gap-3">
              {[
                ...
                <div
                  key={i}
                  className="flex items-center gap-2 px-4 py-2 bg-white border border-stone-100 rounded-2xl text-[11px] font-bold text-stone-600 shadow-sm"
                >
          ...
          <div className="space-y-10">
            <div>
              <div className="flex items-center gap-3 text-[#B38B59] font-bold tracking-[0.2em] uppercase text-xs mb-4">
                <span className="bg-[#B38B59]/10 px-3 py-1 rounded-full whitespace-nowrap">
                  📍 {product.origin}
                </span>
              ...
              <StarRating
                ...
                reviews={product.reviews?.length || 124}
                size={18}
              />
            </div>
            ...
            <div className="p-8 bg-white rounded-3xl border border-stone-100 shadow-sm space-y-8">
              ...
              <div className="flex flex-col sm:flex-row gap-4 pt-4">
                ...
                <div className="flex-1 space-y-4">
                  <div className="text-center sm:text-right">
                    ...
                    <span className="text-xl font-bold text-[#42210B] ml-3">
                      ₹{currentPrice * qty}
                    </span>
                  </div>
                    ...
                    <button
                      ...
                      className={`flex-1 flex items-center justify-center gap-3 py-4 rounded-2xl font-bold text-sm tracking-widest shadow-xl transition-all active:scale-[0.98] ${
                        added
                          ...
                          : 'bg-[#B38B59] hover:bg-[#8C6D45] text-white'
                      }`}
                    >
              ...
              <div className="flex justify-between items-center px-4 py-4 bg-stone-50 rounded-2xl text-[10px] font-bold text-stone-500 uppercase tracking-widest overflow-hidden">
                ...
                <div className="hidden sm:flex items-center gap-2">
                  <ShieldCheck size={14} className="text-[#B38B59]" /> SSL Secure
                </div>
              </div>
            </div>
            ...
            <div className="space-y-8 px-4">
              <div className="space-y-4">
                <h3 className="font-display text-2xl font-bold text-[#42210B]">
                  Experience Pure Essence
                </h3>
              ...
              {product.features && (
                <div className="space-y-6">
                  <h4 className="text-xs font-black text-stone-400 uppercase tracking-[0.3em]">
                  ...
                  <div className="grid gap-4">
                    {product.features.map((feature, i) => (
                      <div
                        key={i}
                        className="flex gap-4 items-start bg-white/50 p-4 rounded-2xl border border-dashed border-stone-200"
                      >
