...
export const MOCK_PRODUCTS: Product[] = [
  {
    ...
    shortName: 'Himalayan Saffron',
    emoji: '🟠',
    badge: 'Premium',
    usp: 'Kashmiri Mongra grade · Hand-picked stigmas',
    features: [
      'Kashmiri Mongra grade — the premium classification for Indian saffron',
      'Hand-picked stigmas only — no yellow stamens or adulteration',
      'Deep red threads with intense crocin colour compound',
      'Authenticated under ISO 3632 saffron quality standard',
    ],
  },
  {
    id: 2,
  ...
  },
  {
    ...
    grade: 'Nonpareil Premium',
    purityTest: '100% natural, unpolished',
  ...
  },
  {
    ...
    shortName: 'Salem Turmeric',
    emoji: '🟡',
    badge: 'Bestseller',
    usp: 'Cold-ground below 10°C · 5–7% curcumin',
    features: [
      'Single-origin Salem, Tamil Nadu — 5–7% curcumin vs 2–3% in mass-market blends',
      'Cold-ground below 10°C — preserves volatile aromatic oils and turmerones',
      'No fillers, no artificial colouring, no anti-caking agents',
      'FSSAI License 12225025000253 · Founded 1965, Sangaria, Rajasthan',
      'Passes all 8 home adulteration tests — water, smell, rub, HCl',
    ],
  },
  {
    id: 5,
  ...
  },
  {
    ...
    features: [
      ...
      'Dramatically more vibrant colour than generic supermarket red chilli powder',
      'Cold-ground to preserve volatile aromatic compounds',
      'No Sudan dye, no brick powder — passes all adulteration tests',
      'The essential ingredient for authentic Rajasthani Laal Maas',
    ],
  },
  {
    id: 13,
    ...
    shortName: 'Whole Coriander Seeds',
    emoji: '🌱',
    badge: null,
    usp: 'Dry-roast and grind at home for maximum freshness',
    features: [
      'Ramganj Mandi origin — the benchmark for Indian coriander quality',
      'Ideal for dry-roasting then grinding fresh at home',
      'Use in biryani tempering, pickling, and spice blends',
      'Higher essential oil content when ground fresh vs pre-ground powder',
    ],
  },
  {
    id: 14,
  ...
  },
  {
    ...
    emoji: '💚',
    badge: null,
    usp: 'Lucknow sweet saunf · High anethole content',
    features: [
      'Lucknow variety — naturally sweeter and more aromatic than ordinary saunf',
      'High anethole content — the compound responsible for digestive properties',
      'Use after meals as a digestive, or in biryani and fish curries',
    ],
  },
  ...
  },
  {
    ...
    features: [
      ...
      'Cold-ground together below 10°C — not blended after individual grinding',
      'No filler spices, no starch, no artificial colour',
      'Family recipe unchanged since 1965, Sangaria, Rajasthan',
      'Add at the end of cooking for maximum aromatic impact',
    ],
  },
  {
    id: 29,
