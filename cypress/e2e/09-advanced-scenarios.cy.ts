...
describe('Advanced Test Scenarios', () => {
  ...
  describe('Wishlist Functionality', () => {
    ...
    it('should add product to wishlist', () => {
      ...
      cy.get('.product-card').first().within(() => {
        cy.get('[class*="heart"], button[aria-label*="wishlist" i]').first().click({ force: true });
      });
    ...
    it('should move wishlist item to cart', () => {
      ...
      cy.get('a[href*="wishlist"], button[aria-label*="wishlist" i]').first().click({ force: true });
      cy.wait(1000);
      
      // Move to cart
      cy.contains('button', /add to cart|move to cart/i).first().click({ force: true });
      cy.wait(500);
  ...
  describe('Product Comparison', () => {
    ...
    it('should add products to comparison', () => {
      ...
      cy.get('.product-card').eq(0).within(() => {
        cy.get('[class*="compare"], button[aria-label*="compare" i]').first().click({ force: true });
      });
      cy.wait(300);
      ...
      cy.get('.product-card').eq(2).within(() => {
        cy.get('[class*="compare"]').first().click({ force: true });
      });
      cy.wait(300);
      
      // Open comparison modal
      cy.get('[class*="comparison"], button').contains(/compare|3/i).click({ force: true });
      cy.wait(500);
    ...
    it('should limit comparison to 4 products', () => {
      ...
      for (let i = 0; i < 5; i++) {
        cy.get('.product-card').eq(i).within(() => {
          cy.get('[class*="compare"]').first().click({ force: true });
        });
        cy.wait(200);
      }
