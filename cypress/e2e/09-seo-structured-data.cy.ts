    ...
    it('should have Organization schema on the homepage', () => {
        cy.get('script[type="application/ld+json"]')
            ...
            .then(($scripts) => {
                ...
                const orgSchema = schemas.find(s => s['@type'] === 'Organization' || (Array.isArray(s) && s.find((i: any) => i['@type'] === 'Organization')));
    ...
    it('should have Product, Breadcrumb, and Recipe schema on product detail', () => {
        ...
        cy.get('script[type="application/ld+json"]')
            ...
            .then(($scripts) => {
                ...
                const productSchema = flattenedSchemas.find(s => s['@type'] === 'Product' && s.name === 'Himalayan Saffron');
